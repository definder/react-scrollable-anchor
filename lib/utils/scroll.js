...
export var doesElementContainScrollTop = function doesElementContainScrollTop(element) {
...
export var checkLocationRelevance = function checkLocationRelevance(el1, el2) {
...
export var checkElementRelevance = function checkElementRelevance(el1, el2) {
  if (el1.contains(el2)) {
...
export var getBestAnchorGivenScrollLocation = function getBestAnchorGivenScrollLocation(anchors, offset) {
  var bestId, bestElement;
